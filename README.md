...
The version of the method *without* the inclusion of radial velocities was applied in Bravi et al. (2018) (http://adsabs.harvard.edu/abs/2018arXiv180301908B). An example of application can be found in examples/example_KinematicModelling.ipynb.
